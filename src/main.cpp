...
uint256 hashGenesisBlock("0x44ac86bef8d5b2dd8aec86c9f2542e26133eefd877ccfcb50cddefc893e3adeb");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(520343692); // Vinzcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Vinzcoin Signed Message:\n";
...
{
    // Vinzcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Vinzcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Vinzcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Vinzcoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Vinzcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Vinzcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Vinzcoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2543a9b0c546c3be46bf34f779ee3eebcbed0111866a14077578f58e439d2b43");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ef239e4d9d8f36a75ca34884f19fd322a804ff433926abd8f53333820f90613d5de1ce6c5ccd7fa8825ae0bb665b84d8a915f41a03cc1ae047fa1f176c754f569c") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1524567994;
        block.nBits    = 520343692;
        block.nNonce   = 3215006008;

        if (fTestNet)
        {
            block.nTime    = 1524567994;
            block.nNonce   = 2409939628;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb8819f2d8b1586fb8837de02131df1cd6618fd695c8d3952075773eeb54be258"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Vinzcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("VinzcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("VinzcoinMiner : ProcessBlock, block not accepted");
    }
